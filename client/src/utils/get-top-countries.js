...
const GetTopCountries = ({countries, active_country, field, sort}) => {
    ...
    return countries
    .sort((a, b) => {
      if(sort == 'alpha_asc' || 'alpha_desc')  return a.country_name < b.country_name ? (sort == 'alpha_asc'? -1: 1) : (sort == 'alpha_asc'? 1: -1)
